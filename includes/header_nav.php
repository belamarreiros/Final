    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-evenly flex-grow-1 pe-3">
          <li class="nav-item">
            <a class="nav-link active <?php echo $current_page == 'index.php' ? 'selecionado' : ''; ?>" aria-current="page" href="index.php">
          ...
          <li class="nav-item">
            <a class="nav-link active <?php echo $current_page == 'fatecons.php' ? 'selecionado' : ''; ?>" aria-current="page" href="fatecons.php">
          ...
          <li class="nav-item">
            <a class="nav-link active <?php echo $current_page == 'premiacoes.php' ? 'selecionado' : ''; ?>" aria-current="page" href="premiacoes.php">
          ...
          <li class="nav-item">
            <a class="nav-link active <?php echo $current_page == 'cartunistas.php' ? 'selecionado' : ''; ?>" aria-current="page" href="cartunistas.php">
          ...
          <li class="nav-item">
            <a class="nav-link active <?php echo $current_page == 'rubens.php' ? 'selecionado' : ''; ?>" aria-current="page" href="rubens.php">
          ...
          <li class="nav-item">
            <a class="nav-link active <?php echo $current_page == 'nos.php' ? 'selecionado' : ''; ?>" aria-current="page" href="nos.php">
          ...
          <li class="nav-item">
            <a class="nav-link active <?php echo $current_page == 'contato.php' ? 'selecionado' : ''; ?>" aria-current="page" href="contato.php">
          ...
          <li class="nav-item">
            <a class="nav-link active <?php echo $current_page == 'normas.php' ? 'selecionado' : ''; ?>" aria-current="page" href="normas.php">
